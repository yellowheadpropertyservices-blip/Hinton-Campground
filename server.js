      ...
      try {
        ...
        if (d.email) {
          sendEmail(d.email, 'Booking Confirmed: ' + d.confNum + ' - Hinton Campgrounds',
            ...
            '</table>' +
            '<p style="margin-top:16px;padding:12px;background:#f2f2f2;border-radius:6px;font-size:13px"><strong>Washroom Access (keypad entry overnight):</strong><br>Men: <strong>2749</strong> &nbsp; Women: <strong>5016</strong></p>' +
